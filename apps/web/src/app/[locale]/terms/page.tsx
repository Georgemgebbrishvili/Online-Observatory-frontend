...
export default async function TermsRoute({ params }: LegalRouteProps) {
  const { locale } = await params;
  ...
  return (
    <div className="site-frame">
      ...
      <LegalDocumentPage copy={copy} document={copy.documents.terms} locale={locale} />
      <SiteFooter footer={dictionary.footer} locale={locale} path={legalPaths.terms} />
    </div>
  );
}
